                                ...
                                <span>
                                    ...
                                    <Dropdown
                                        ...
                                        <Dropdown.Menu>
                                            ...
                                            <Dropdown.Item >
                                                <Accordion>
                                                    <Accordion.Title active={activeIndex === 0} index={0} onClick={this.handleItemClick} content='Status'>
                                                        <Icon name='dropdown' />
                                                    </Accordion.Title>
                                            ...
                                            <Dropdown.Item >
                                                <Accordion>
                                                    <Accordion.Title active={activeIndex === 1} index={1} onClick={this.handleItemClick} content="Expiry Date">
                                                        <Icon name='dropdown' />
                                                    </Accordion.Title>
